    ...
    const fetchChartData = async () => {
      ...
      try {
        const res = await fetch(
          "http://localhost:8080/api/analysis/search-by-period?sessionId=6de97703-e4bd-40fd-81b8-b40cd3b174dd&durationStart=2025-07-01&durationEnd=2025-08-31&interval=day"
        )
    ...
    <Card className="h-full">
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle className="flex items-center gap-2">
          <BarChart3 className="h-5 w-5" />📊 일별 수입/지출 비교
