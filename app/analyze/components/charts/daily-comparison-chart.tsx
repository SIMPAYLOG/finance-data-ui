    ...
    const fetchChartData = async () => {
      ...
      try {
        const res = await fetch(
          `http://localhost:8080/api/analysis/search-by-period?sessionId=${sessionId}&durationStart=${filters.dateRange.start}&durationEnd=${filters.dateRange.end}&interval=day`
        )
